...
from app.internal.simpcity.simpcity import get_threads_list, get_thread_info, get_thread_posts
...
class ThreadInfo(BaseModel):
    ...
    thread_url: str
    posts_count: int
    latest_post_timestamp: Optional[datetime] = None
    first_post_timestamp: Optional[datetime] = None
    authors_count: int
